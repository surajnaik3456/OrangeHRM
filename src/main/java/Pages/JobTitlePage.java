...
public class JobTitlePage extends TestBase {
	...
	By editButton = By.xpath("//div[text()='Account Assistant']/parent::div/parent::div//button[@class='oxd-icon-button oxd-table-cell-action-space'][2]");
	By dltButton = By.xpath("//div[text()='Account Assistant']/parent::div/parent::div//button[@class='oxd-icon-button oxd-table-cell-action-space'][1]");
